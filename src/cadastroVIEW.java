...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (cadastroNome.getText().isBlank() && cadastroValor.getText().isBlank()) {
            JOptionPane.showMessageDialog(rootPane, "Digite o nome e valor do produto antes de tentar cadastrar");
        } else if (cadastroNome.getText().isBlank()) {
            JOptionPane.showMessageDialog(rootPane, "Digite o nome do produto antes de tentar cadastrar");
        } else if (cadastroValor.getText().isBlank()) {
            JOptionPane.showMessageDialog(rootPane, "Digite o valor do produto antes de tentar cadastrar");
        } else {
